...
Developed and currently maintain a mobile application for personal, family, and shared budget management. Designed the underlying data model and implemented transaction processing, accounts, budgets, shared expenses, participant balances, and debt settlement.

The application follows an offline-first architecture using a local SQLite database, with cloud synchronization and authentication designed around Firebase.
...
Developed an automated data collection pipeline for monitoring competitor product prices across e-commerce websites.

Implemented web scraping and browser automation, transformed collected data into structured datasets, and stored historical pricing information in a PostgreSQL database hosted on a remote server.
...
Developed a Python-based data processing solution for financial transaction data from the Moscow Exchange.
